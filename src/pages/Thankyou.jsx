  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-primary/20">
      ...
      <div className="wrapper h-full flex flex-col items-center py-[8rem] gap-3 text-white text-center">
        ...
        <p className="desc">
          Thank you for reaching out to us! We have received your message and will respond to you as soon as possible.
        </p>
          ...
          <div className="flex md:flex-row flex-col justify-between gap-10">
            <div className="flex flex-col items-center">
              ...
              <p className="desc md:max-w-[15rem] text-sm text-center">
                We have established ourselves as a trusted partner for organizations seeking digital transformation and enhanced operational efficiency.
              </p>
            </div>
