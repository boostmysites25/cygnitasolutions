          ...
          <div className="relative z-10 px-6 justify-center h-full flex flex-col items-center gap-5 text-center md:max-w-[60rem] mx-auto">
            ...
            <h1 className="heading-1 text-white">
              {isWebDevelopment
                ...
                : "Bring Your Ideas to Life with Innovative Mobile Applications"}
            </h1>
            <p className="text-white/90 desc">
              Creating powerful digital solutions that drive business growth and enhance user experiences.
            </p>
            <ScrollLink
              to="contact"
              smooth
          ...
          >
            <div className="flex flex-col gap-7">
              <h2 className="heading-2">
                {isWebDevelopment
                  ? "Revolutionary Web Solutions for Modern Businesses"
                  : "Advanced Mobile Applications Designed for Success and Growth"}
              </h2>
              <p className="desc">
                {isWebDevelopment
                  ? "We blend creativity with technical excellence to build websites that perfectly represent your brand while providing seamless user experiences across all devices and platforms."
                  : "From startups to established enterprises, we deliver comprehensive app development services customized to your specific needs. Our applications are built to captivate users, optimize performance, and scale with your business growth."}
              </p>
            </div>
      ...
      <section className="py-[5rem] bg-black text-white">
        <div className="wrapper text-center flex flex-col gap-3">
          ...
          <p data-aos="fade-up" className="desc max-w-[50rem] mx-auto">
            In today's rapidly evolving digital landscape, your online presence serves as the cornerstone of your brand identity and business success. We recognize that a website is not merely a digital brochure but a powerful tool that can transform how customers interact with your business. Our development approach focuses on creating comprehensive digital experiences that not only capture attention but also drive meaningful engagement and measurable business results.
          </p>
        </div>
      </section>
          ...
          <div className="flex justify-center md:justify-normal gap-5">
            ...
            >
              ...
              <p className="desc text-white/70">
                Build powerful digital solutions that drive business growth and success
              </p>
            </div>
          </div>
        </div>
