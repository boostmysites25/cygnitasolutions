      ...
      <div className="wrapper">
        <div className="h-full grid md:grid-cols-2 gap-10 py-10">
          <div data-aos="fade-right" className="flex flex-col gap-4">
            <h2 className="heading-2">Let's Start Your Digital Journey!</h2>
            <p className="desc">
              Ready to transform your business with innovative digital solutions? <br /> Connect with{" "}
              <span className="font-semibold">Cygnita Solutions</span>{" "}
              today and explore how we can help you achieve your business objectives.
            </p>
          </div>
          <form
            data-aos="fade-left"
