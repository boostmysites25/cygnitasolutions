...
const ContactForm = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    var payload = {
      ...
      subject: "Contact Form Submission - Cygnita Solutions",
      body: emailBody,
  ...
  return (
    <div className="wrapper py-[5rem] grid lg:grid-cols-[45%_auto] gap-7">
      ...
      >
        ...
        <h2 className="heading-2 mt-5">Connect With Us</h2>
        <p className="desc">
          Ready to transform your business with innovative digital solutions? <br />
          Let's collaborate to bring your vision to life and elevate your
