          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-5 mt-9">
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  Our team brings deep technical knowledge and expertise across modern development technologies and frameworks.
                </p>
              </div>
              <div
                data-aos="fade-right"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We stay ahead of industry trends and adapt our solutions to meet evolving business needs and technological advancements.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5 h-full">
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We maintain transparent communication throughout the project lifecycle, ensuring you're always informed and involved.
                </p>
              </div>
              <div
                data-aos="fade-left"
              ...
              >
                ...
                <p className="desc text-white/80 text-start mt-3">
                  We implement robust security measures and ensure compliance with industry standards to protect your data and systems.
                </p>
              </div>
            </div>
          </div>
